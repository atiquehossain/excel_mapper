...
class Languages {
  ...
  String get If_the_applicant_or_the_family_has_any_forms_of_machinery_related_to_economic_activity_select_Yes_otherwise_select_No => "If the applicant or the family has any forms of machinery related to economic activity, select Yes otherwise select No. 
...
";
  ...
  String get Select_the_nature_type_of_the_residence_where_the_applicant_and_family_live_from_the_colors_above => "Select the nature/type of the residence where the applicant and family live from the colors above.
";
  ...
  String get Materials_used_for_the_roofing_of_the_house => "Materials used for the roofing of the house
...
";
  ...
  String get Image_of_the_roof_of_the_house => "Image of the roof of the house
";
...
	Select the relevant item from the options provided in the box regarding the ownership of the applicant's residence.";
  ...
  String get click_infront_of_the_main_source_of_light_that_the_applicant_family_members_use_If_there_are_several_sources_of_light_for_the_house_include_only_the_main_source_that_is_primarily_used => "click infront of the main source of light that the applicant/family members use.
If there are several sources of light for the house, include only the main source that is primarily used";
  ...
  String get Click_in_front_of_the_main_source_of_drinking_water_that_the_applicant_family_members_use_If_there_are_several_sources_of_drinking_water_include_only_the_main_source_that_is_primarily_used => "Click in front of the main source of drinking water that the applicant/family members use
If there are several sources of drinking water, include only the main source that is primarily used.";
  ...
  String get what_natural_disasters_have_affected_the_house_in_the_past_5_years_Please_specify => "what natural disasters have affected the house in the past 5 years? Please specify.
";
  String get Information_regarding_natural_disasters => "Information regarding natural disasters";
  String get Click_on_the_Get_Location_to_obtain_the_location_of_the_applicant_s_housing_unit_via_GPS_technology_The_latitude_and_longitude_of_the_applicant_s_home_location_should_be_acquired_here => "Click on the  "Get Location" to obtain the location of the applicant's housing unit via GPS technology.
...
";
  ...
  String get Four_photos_should_be_taken_the_front_back_side_and_interior_of_the_house => "Four photos should be taken: the front, back, side, and interior of the house.
";
