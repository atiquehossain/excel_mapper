...
class AssetinfoModel {
  ...
  final int crops_grown_land;
  final int have_cultivable_paddy_land;
  final String total_cultivable_paddy_land;
  final int have_owns_vehicles;
  final int vehicles_type;
  final int have_economic_machinery;
  final int machinery_type;
  final double have_animal_husbandry_livestock;
  final int animal_husbandry_livestock_type;
  final int house_type;
  final int house_floor_type;
  final String image_floor;
  final int house_roof_type;
  final int house_wall_type;
  final String house_roof_img;
  final int house_floor_area;
  final String has_secure_door_windows;
  final String residential_nature;
  final String residential_ownership;
  final int has_other_house;
  final int light_source;
  final int drinking_water_source;
  final int sanitation_facilities;
  final int toilet_type;
