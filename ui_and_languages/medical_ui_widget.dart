      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            condition: true, 
            widget: MedicalUI(
                label: Languages.getText(context)!.Information_about_the_difficulties_suffered_by_the_member_n,
                question: Languages.getText(context)!.Select_only_the_item_with_which_the_member_is_experiencing_severe_difficulty_If_there_is_no_difficulty_select_nitem,
                ...
                onChanged: (value) {
                    ...
                    selectedOptions[Languages.getText(context)!.Select_only_the_item_with_which_the_member_is_experiencing_severe_difficulty_If_there_is_no_difficulty_select_nitem] = SetupConstant.difficulties + AppConstant.SEPERATOR + value;
                },
            ),
            ),
            ...
            widget: MedicalUI(
                ...
                onChanged: (value) {
                    ...
                    selectedOptions[Languages.getText(context)!.If_the_respective_member_is_a_disabled_person_select_the_code_Yes_or_No] = SetupConstant.yes_no + AppConstant.SEPERATOR + value;
                },
            ),
            ),
            ...
            widget: MedicalUI(
                ...
                onChanged: (value) {
                    ...
                    selectedOptions[Languages.getText(context)!.If_the_respective_member_is_disabled_select_the_disability_status_After_selecting_the_relevant_disability_select_the_correct_item_from_below_about_how_the_disability_occurred] = SetupConstant.disability + AppConstant.SEPERATOR + value;
                },
            ),
            ),
            ...
            widget: MedicalUI(
                ...
                onChanged: (value) {
                    ...
                    selectedOptions[Languages.getText(context)!.Click_picture_of_the_record_and_upload_it_here] = null + AppConstant.SEPERATOR + value;
                },
            ),
            ),
            ...
            widget: MedicalUI(
                ...
                onChanged: (value) {
                    ...
                    selectedOptions[Languages.getText(context)!.if_the_member_is_suffering_from_chronic_diseases] = SetupConstant.chronic_illness + AppConstant.SEPERATOR + value;
                },
            ),
            ),
            ...
            widget: MedicalUI(
                ...
                onChanged: (value) {
                    ...
                    selectedOptions[Languages.getText(context)!.Select_Yes_if_the_respective_member_is_suffering_from_any_chronic_medical_condition_and_if_not_suffering_select_No] = SetupConstant.yes_no + AppConstant.SEPERATOR + value;
                },
            ),
            ),
            ...
            widget: MedicalUI(
                ...
                onChanged: (value) {
                    ...
                    selectedOptions[Languages.getText(context)!.Select_Yes_or_No_if_the_respective_member_is_suffering_from_undiagnosed_kidney_disease] = SetupConstant.yes_no + AppConstant.SEPERATOR + value;
                },
            ),
            ),
            ...
            widget: MedicalUI(
                ...
                onChanged: (value) {
                    ...
                    selectedOptions[Languages.getText(context)!.If_a_person_is_being_treated_for_such_kidney_disease_mention_the_name_of_the_hospital_where_he_is_being_treated] = null + AppConstant.SEPERATOR + value;
                },
            ),
            ),
            ...
            widget: MedicalUI(
                ...
                onChanged: (value) {
                    ...
                    selectedOptions[Languages.getText(context)!.If_the_concerned_member_is_suffering_from_kidney_disease_and_is_currently_undergoing_dialysis_select_yes_if_not_so_select_no] = SetupConstant.yes_no + AppConstant.SEPERATOR + value;
                },
            ),
            ),
            ...
            widget: MedicalUI(
                ...
                onChanged: (value) {
                    ...
                    selectedOptions[Languages.getText(context)!.If_the_relevant_member_is_under_dialysis_request_for_the_relevant_reports_to_confirm_it] = null + AppConstant.SEPERATOR + value;
                },
            ),
            ),
