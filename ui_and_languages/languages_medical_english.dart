...
/// Medical localization file -  2025-01-01



  String get Select_only_the_item_with_which_the_member_is_experiencing_severe_difficulty_If_there_is_no_difficulty_select_item => "Select only the item with which the member is experiencing severe difficulty. If there is no difficulty, select                
item.";
  String get Information_about_the_difficulties_suffered_by_the_member => "Information about the difficulties suffered by the member";
