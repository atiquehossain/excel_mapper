          ...
          children: [
                    ...
                    widget: IncomeinfoUI(
                        ...
                        onChanged: (value) {
                            ...
                            selectedOptions[Languages.getText(context)!.The_highest_professional_qualification_level_of_the_respective_member_select_the_relevant_item_and_click_on_its_button_If_it_doesn_t_know_about_it_click_on_the_Unknown_item] = SetupConstant.professional_level 
                    ...
                    widget: IncomeinfoUI(
                        ...
                        onChanged: (value) {
                            ...
                            selectedOptions[Languages.getText(context)!.Select_the_correct_item_for_the_nature_of_the_job] = SetupConstant.nature_of_job 
                                + AppConstant.SEPERATOR 
                                + value;
                        },
                    ),
                    ...
                    widget: IncomeinfoUI(
                        ...
                        onChanged: (value) {
                            ...
                            selectedOptions[Languages.getText(context)!.Select_the_field_department_related_to_the_main_economic_activity_that_is_currently_engaged_in] = SetupConstant.department_of_job 
                                + AppConstant.SEPERATOR 
                                + value;
                        },
                    ),
                    ...
                    widget: IncomeinfoUI(
                        ...
                        onChanged: (value) {
                            ...
                            selectedOptions[Languages.getText(context)!.Has_the_respective_member_already_received_government_assistance] = null 
                                + AppConstant.SEPERATOR 
                                + value;
                        },
                    ),
                    ...
                    widget: IncomeinfoUI(
                        ...
                        onChanged: (value) {
                            ...
                            selectedOptions[Languages.getText(context)!.Enter_which_welfare_program_that_government_assistance_is_received_by_the_respective_member] = SetupConstant.walfare_type 
                                + AppConstant.SEPERATOR 
                                + value;
                        },
                    ),
                    ...
                    widget: IncomeinfoUI(
                        ...
                        onChanged: (value) {
                            ...
                            selectedOptions[Languages.getText(context)!.Do_you_recieve_samurdhi] = null 
                                + AppConstant.SEPERATOR 
                                + value;
                        },
                    ),
                    ...
                    widget: IncomeinfoUI(
                        ...
                        onChanged: (value) {
                            ...
                            selectedOptions[Languages.getText(context)!.Is_the_applicant_s_family_previous_recipient_of_Samurdhi_grant_Or_not_Select_the_correct_item_in_that_respect] = SetupConstant.samurdhi_beneficiary_type 
                                + AppConstant.SEPERATOR 
                                + value;
                        },
                    ),
                    ...
                    widget: IncomeinfoUI(
                        ...
                        onChanged: (value) {
                            ...
                            selectedOptions[Languages.getText(context)!.Select_the_category_relevant_to_that_family_from_the_following_expenditure_categories] = SetupConstant.expenses_category 
                                + AppConstant.SEPERATOR 
                                + value;
                        },
                    ),
                    ...
                    widget: IncomeinfoUI(
                        ...
                        onChanged: (value) {
                            ...
                            selectedOptions[Languages.getText(context)!.Is_the_aapplicant_is_an_electricity_consumer] = null 
                                + AppConstant.SEPERATOR 
                                + value;
                        },
                    ),
                    ...
                    widget: IncomeinfoUI(
                        ...
                        onChanged: (value) {
                            ...
                            selectedOptions[Languages.getText(context)!.Please_enter_the_number_of_electricity_units_consumed_monthly] = null 
                                + AppConstant.SEPERATOR 
                                + value;
                        },
                    ),
                    ...
                    widget: IncomeinfoUI(
                        ...
                        onChanged: (value) {
                            ...
                            selectedOptions[Languages.getText(context)!.indicate_the_account_number_from_the_electricity_bill] = null 
                                + AppConstant.SEPERATOR 
                                + value;
                        },
                    ),
                    ...
                    widget: IncomeinfoUI(
                        ...
                        onChanged: (value) {
                            ...
                            selectedOptions[Languages.getText(context)!.Has_the_member_faced_a_loss_of_livelihood_in_the_past_6_months_If_there_has_been_a_loss_of_livelihood_select_yes_if_not_select_no] = null 
                                + AppConstant.SEPERATOR 
                                + value;
                        },
                    ),
                    ...
                    widget: IncomeinfoUI(
                        ...
                        onChanged: (value) {
                            ...
                            selectedOptions[Languages.getText(context)!.If_the_member_has_faced_a_loss_of_livelihood_in_the_past_6_months_please_select_and_specify_what_type_of_livelihood_has_been_lost] = SetupConstant.loss_of_livelihood_type 
                                + AppConstant.SEPERATOR 
                                + value;
                        },
                    ),
                    ...
                    widget: IncomeinfoUI(
                        ...
                        onChanged: (value) {
                            ...
                            selectedOptions[Languages.getText(context)!.Please_provide_details_about_the_type_of_fuel_required_for_family_transportation_economic_activities_and_household_tasks_along_with_the_monthly_fuel_consumption] = null 
                                + AppConstant.SEPERATOR 
                                + value;
                        },
                    ),
                    ...
                    widget: IncomeinfoUI(
                        ...
                        onChanged: (value) {
                            ...
                            selectedOptions[Languages.getText(context)!.Specify_monthly_fuel_amount_below] = null 
                                + AppConstant.SEPERATOR 
                                + value;
                        },
                    ),
                    ...
                    widget: IncomeinfoUI(
                        ...
                        onChanged: (value) {
                            ...
                            selectedOptions[Languages.getText(context)!.Specify_the_main_fuel_used_for_cooking_food] = SetupConstant.cooking_fuel_type 
                                + AppConstant.SEPERATOR 
                                + value;
                        },
                    ),
