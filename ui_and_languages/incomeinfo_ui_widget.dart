      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            condition: true, 
            widget: IncomeinfoUI(
                label: Languages.getText(context)!.Professional_level_attained_by_the_member_n,
            ...
            widget: IncomeinfoUI(
                ...
                question: Languages.getText(context)!.Specify_the_main_fuel_used_for_cooking_food_n,
                fieldType: AppConstant.FieldType_multiple_choice,
                ...
                onChanged: (value) {
                    ...
                    selectedOptions[Languages.getText(context)!.Specify_the_main_fuel_used_for_cooking_food_n] = SetupConstant.cooking_fuel_type + AppConstant.SEPERATOR + value;
                },
            ),
            ),
