...
class _IncomeinfoScreenState extends State<IncomeinfoScreen> {
  ...
  void initState() {
    if (widget.peddingData != null) {
      incomeinfo =
          Incomeinfo.fromJson(widget.peddingData as Map<String, dynamic>);
    } else {
  ...
  Widget build(BuildContext context) {
    return PageUF(
      appBar: appBarGeneral(context, appColor,
          title: Languages.getText(context)!.Incomeinfo),
        ...
        child: Column(
          children: [
            ...
            buildQuestion(
              ...
              condition: true,
              widget: IncomeinfoUI(
                label: Languages.getText(context)!
                    .Professional_level_attained_by_the_member,
                question: Languages.getText(context)!
                    .which_welfare_program_that_government_assistance_is_received_by_the_respective_member,
                fieldType: AppConstant.FieldType_dropdown,
                model: incomeinfo.professional_level,
                dataList: SetupData.getDropDownItems(
                    context, SetupConstant.professional_level),
                onChanged: (value) {
                  incomeinfo.professional_level = value;
                  selectedOptions[Languages.getText(context)!
                          .which_welfare_program_that_government_assistance_is_received_by_the_respective_member] =
                      SetupConstant.professional_level +
            ...
            buildQuestion(
              ...
              widget: IncomeinfoUI(
                label: Languages.getText(context)!
                    .Main_economic_activity_in_which_the_member_is_engaged,
                question: Languages.getText(context)!
                    .Select_the_correct_item_for_the_nature_of_the_job,
                fieldType: AppConstant.FieldType_dropdown,
                model: incomeinfo.nature_of_job,
                dataList: SetupData.getDropDownItems(
                    context, SetupConstant.nature_of_job),
                onChanged: (value) {
                  incomeinfo.nature_of_job = value;
                  selectedOptions[Languages.getText(context)!
                          .Select_the_correct_item_for_the_nature_of_the_job] =
                      SetupConstant.nature_of_job +
                          AppConstant.SEPERATOR +
                          value;
                },
              ),
            ...
            buildQuestion(
              ...
              widget: IncomeinfoUI(
                label: Languages.getText(context)!
                    .Area_of_the_main_economic_activity_of_the_member,
                question: Languages.getText(context)!
                    .Select_the_field_department_related_to_the_main_economic_activity_that_is_currently_engaged_in,
                fieldType: AppConstant.FieldType_dropdown,
                model: incomeinfo.department_of_job,
                dataList: SetupData.getDropDownItems(
                    context, SetupConstant.department_of_job),
                onChanged: (value) {
                  incomeinfo.department_of_job = value;
                  selectedOptions[Languages.getText(context)!
                          .Select_the_field_department_related_to_the_main_economic_activity_that_is_currently_engaged_in] =
                      SetupConstant.department_of_job +
                          AppConstant.SEPERATOR +
                          value;
                },
              ),
            ...
            buildQuestion(
              ...
              widget: IncomeinfoUI(
                label: Languages.getText(context)!
                    .Information_about_current_social_welfare_programs_that_the_benefits_are_received,
                question: Languages.getText(context)!
                    .Has_the_respective_member_already_received_government_assistance,
                fieldType: AppConstant.FieldType_radio,
                model: incomeinfo.received_walfare_assistance,
                dataList:
                    SetupData.getDropDownItems(context, SetupConstant.yes_no),
                onChanged: (value) {
                  incomeinfo.received_walfare_assistance = value;
                  selectedOptions[Languages.getText(context)!
                          .Has_the_respective_member_already_received_government_assistance] =
                      SetupConstant.yes_no + AppConstant.SEPERATOR + value;
                },
              ),
            ),
            ...
            buildQuestion(
              ...
              widget: IncomeinfoUI(
                label: Languages.getText(context)!
                    .Details_of_receipt_of_welfare_benefits,
                question: Languages.getText(context)!
                    .Enter_which_welfare_program_that_government_assistance_is_received_by_the_respective_member,
                fieldType: AppConstant.FieldType_dropdown,
                model: incomeinfo.walfare_type,
                dataList: SetupData.getDropDownItems(
                    context, SetupConstant.walfare_type),
                onChanged: (value) {
                  incomeinfo.walfare_type = value;
                  selectedOptions[Languages.getText(context)!
                          .Enter_which_welfare_program_that_government_assistance_is_received_by_the_respective_member] =
                      SetupConstant.walfare_type +
                          AppConstant.SEPERATOR +
                          value;
                },
              ),
            ...
            buildQuestion(
              ...
              widget: IncomeinfoUI(
                label: Languages.getText(context)!
                    .Details_of_Samrudhi_beneficiaries,
                question: Languages.getText(context)!
                    .Is_the_applicant_s_family_previous_recipient_of_Samurdhi_grant_Or_not,
                fieldType: AppConstant.FieldType_radio,
            ...
            buildQuestion(
              ...
              widget: IncomeinfoUI(
                ...
                dataList: SetupData.getCheklistItems(
                    context, SetupConstant.samurdhi_benefit_value),
                onChanged: (value) {
                  incomeinfo.samurdhi_benefit_value = value;
                  selectedOptions[
                          Languages.getText(context)!.Do_you_recieve_samurdhi] =
                      SetupConstant.samurdhi_benefit_value +
                          AppConstant.SEPERATOR +
                          value;
                },
              ),
            ...
            buildQuestion(
              ...
              widget: IncomeinfoUI(
                label: Languages.getText(context)!
                    .Details_of_monthly_expenses_of_the_family,
                question: Languages.getText(context)!
                    .Select_the_category_relevant_to_that_family_from_the_following_expenditure_categories,
            ...
            buildQuestion(
              ...
              widget: IncomeinfoUI(
                label: Languages.getText(context)!
                    .Details_about_the_family_s_electricity_consumption,
                question: Languages.getText(context)!
                    .Is_the_aapplicant_is_an_electricity_consumer,
                fieldType: AppConstant.FieldType_radio,
            ...
            buildQuestion(
              ...
              widget: IncomeinfoUI(
                ...
                onChanged: (value) {
                  ...
                  selectedOptions[
                          Languages.getText(context)!.Missing_value_in_excel] =
                      null + AppConstant.SEPERATOR + value;
                },
              ),
            ),
            ...
            buildQuestion(
              ...
              widget: IncomeinfoUI(
                label: Languages.getText(context)!
                    .Details_about_the_number_of_electricity_units_consumed_monthly,
                question: Languages.getText(context)!
                    .Please_enter_the_number_of_electricity_units_consumed_monthly,
                fieldType: AppConstant.FieldType_EditText,
            ...
            buildQuestion(
              ...
              widget: IncomeinfoUI(
                label: Languages.getText(context)!
                    .Details_about_the_account_number_on_the_electricity_bill,
                question: Languages.getText(context)!
                    .indicate_the_account_number_from_the_electricity_bill,
                fieldType: AppConstant.FieldType_EditText,
            ...
            buildQuestion(
              ...
              widget: IncomeinfoUI(
                label: Languages.getText(context)!
                    .Information_regarding_loss_of_livelihood,
                question: Languages.getText(context)!
                    .Has_the_member_faced_a_loss_of_livelihood_in_the_past_6_months_If_there_has_been_a_loss_of_livelihood_select_yes_if_not_select_no,
                fieldType: AppConstant.FieldType_radio,
            ...
            buildQuestion(
              ...
              widget: IncomeinfoUI(
                ...
                question: Languages.getText(context)!
                    .If_the_member_has_faced_a_loss_of_livelihood_in_the_past_6_months_please_select_and_specify_what_type_of_livelihood_has_been_lost,
                fieldType: AppConstant.FieldType_radio,
            ...
            buildQuestion(
              ...
              widget: IncomeinfoUI(
                label: Languages.getText(context)!
                    .Information_on_the_family_s_monthly_fuel_consumption,
                question: Languages.getText(context)!
                    .Please_provide_details_about_the_type_of_fuel_required_for_family_transportation_economic_activities_and_household_tasks_along_with_the_monthly_fuel_consumption,
                fieldType: AppConstant.FieldType_dropdown,
                model: incomeinfo.required_fuel_type,
                dataList: SetupData.getDropDownItems(
                    context, SetupConstant.required_fuel_type),
                onChanged: (value) {
                  incomeinfo.required_fuel_type = value;
                  selectedOptions[Languages.getText(context)!
                          .Please_provide_details_about_the_type_of_fuel_required_for_family_transportation_economic_activities_and_household_tasks_along_with_the_monthly_fuel_consumption] =
                      SetupConstant.required_fuel_type +
                          AppConstant.SEPERATOR +
                          value;
                },
              ),
          ...
          Padding(
            ...
            child: Text(
              ...
              style: TextStyle(
                ...
                fontSize:
                    AppDimens.getTextSize(textSizeType: TextSizeType.normal),
