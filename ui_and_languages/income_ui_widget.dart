    ...
    return PageUF(
      ...
      body: Column(
        ...
        IncomeUI(
          ...
          dataList: SetupData.getDropDownItems(context,null),
          onChanged: (value) {
              income.samurdhi_benefit_value = value;
              selectedOptions[Languages.getText(context)!.Do_you_recieve_samurdhi] = null + AppConstant.SEPERATOR + value;
          },
        ),
        ...
        IncomeUI(
          ...
          dataList: SetupData.getDropDownItems(context,SetupConstant.cooking_fuel_type),
          onChanged: (value) {
